...
cursor.execute("CREATE TABLE Students (id INT PRIMARY KEY, name Varchar(32), surname Varchar(32), age INT, city Varchar(32))")
cursor.execute("CREATE TABLE Courses (id INT PRIMARY KEY, name Varchar(32), time_start Varchar(32), time_end  Varchar(32))")
